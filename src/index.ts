...
import GoTypesComponent from "./routes/go_types.vue";
import GoApiComponent from "./routes/go_api.vue";
import "prismjs";
...
export default {
  ...
  routes: [
    ...
    {
      path: "/generate-types/gotypes",
      component: GoTypesComponent,
    },
    {
      path: "/generate-types/goapi",
      component: GoApiComponent,
    },
  ],
  hidden: false,
